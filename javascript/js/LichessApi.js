...
class LichessApi {
  ...
  challenge(username, parameters) {
    return this.post(`api/challenge/${username}`, parameters)
  }

  challengeAI(parameters) {
    return this.post(`api/challenge/ai`, parameters)
  }

  seek(parameters) {
    return this.post('api/board/seek', parameters)
  }
  ...
  makeMoveBoard(gameId, move) {
    var params = {
      offeringDraw: false
    }
    return this.post(`api/board/game/${gameId}/move/${move}`, $.param(params));
  }
  ...
  streamGameBoard(gameId, handler) {
    return this.stream(`api/board/game/stream/${gameId}`, handler);
  }
  ...
  chatBoard(gameId, room, text) {
    params = {
      room: room,
      text: text
    }
    return this.post(`api/bot/game/${gameId}/chat`, $.param(params));
  }
